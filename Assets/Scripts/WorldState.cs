...
public class WorldState : MonoBehaviour
{
    ...
    public enum GameState { SplashScreen, Menu, Game, Elevator, Intermission_Flora_In, Intermission_Pieczara_Reveal, Intermission_WaitingForNumber, Intermission_TopTitle };
